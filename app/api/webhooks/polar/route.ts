...
const PRODUCT_PLAN_MAP: Record<string, string> = {
  ...(process.env.POLAR_STARTER_PRODUCT_ID ? { [process.env.POLAR_STARTER_PRODUCT_ID]: 'starter' } : {}),
  ...
  onPayload: async (payload) => {
    ...
    switch (event) {
      ...
      case 'subscription.active': {
        ...
        const credits = PLAN_CREDITS[plan as keyof typeof PLAN_CREDITS] ?? PLAN_CREDITS.starter;
